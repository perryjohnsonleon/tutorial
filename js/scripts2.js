...
const element1 = document.getElementById("myBar1");
	  const canvas=document.getElementById("hiddenMsg2") ;
	  const mask_item1 = document.getElementById("hiddenMsg1") , mask_item2=document.getElementById("myChart") ,mask_item3 = document.getElementById("hiddenMsg2") , mask_item4 = document.getElementById("collapseBtn2") ;
 ...
 async function newChart() {
		...
		if (oldCanvas) {
		  console.log(45678);
		  oldCanvas.outerHTML = "<canvas id='myChart' width='400' height='200'></canvas>" ;
		}	
	}

 async function getPost(stockNo) {
  let result=await newChart();	 
  try {
...
async function displayPost(stockNo,firstVisit) {	
  ...
  if (post) {
    ...
    // showChart final steps begining
  	mask_item2.style.display = "block" ;
    $("#collapseBtn2").html("<img src='collapse.png' style='cursor:pointer;' onclick='collapseElement2()' />");	
	mask_item4.style.display = "block" ;
    // showChart final steps ending
  }   
